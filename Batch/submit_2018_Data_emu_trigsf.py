...
def Make_CondorScr(sampleName, outputName, runPeriod, Channels, NumFileList, NumJob):
    ...
    if "Run2017B" in sampleName:
        ...
        config_file = "ULSummer20/UL2018/muelec_Data.config"
...
if __name__ == '__main__':
    ...
    # Data samples
    #MC
    Make_CondorScr("Data_MET_Run2018A_trigsf", "Data_MET_Run2018A_trigsf" + output_suffix, run_period, channels, 555, num_jobs)
    Make_CondorScr("Data_MET_Run2018B_trigsf", "Data_MET_Run2018B_trigsf" + output_suffix, run_period, channels, 262, num_jobs)
    Make_CondorScr("Data_MET_Run2018C_trigsf", "Data_MET_Run2018C_trigsf" + output_suffix, run_period, channels, 263, num_jobs)
    Make_CondorScr("Data_MET_Run2018D_trigsf", "Data_MET_Run2018D_trigsf" + output_suffix, run_period, channels, 629, num_jobs)
