...
SE_OUTPUT_DIR = "/u/user/dwkim/SE_UserHome/TOP_CPV_output/2024_trigSF"
...
def Make_CondorScr(sampleName, outputName, runPeriod, Channels, NumFileList, NumJob):
    ...
    if "Run2017B" in sampleName:
        ...
        config_file = "Run3/2024/muelec.config"
...
if __name__ == '__main__':
    ...
    # Data samples
    Make_CondorScr("Data_JetMET0_Run2024C_trigsf", "Data_JetMET0_Run2024C_trigsf" + output_suffix, run_period, channels, 237, num_jobs)
    Make_CondorScr("Data_JetMET0_Run2024D_trigsf", "Data_JetMET0_Run2024D_trigsf" + output_suffix, run_period, channels, 232, num_jobs)
    Make_CondorScr("Data_JetMET0_Run2024E_trigsf", "Data_JetMET0_Run2024E_trigsf" + output_suffix, run_period, channels, 315, num_jobs)
    Make_CondorScr("Data_JetMET0_Run2024F_trigsf", "Data_JetMET0_Run2024F_trigsf" + output_suffix, run_period, channels, 697, num_jobs)
    Make_CondorScr("Data_JetMET0_Run2024G_trigsf", "Data_JetMET0_Run2024G_trigsf" + output_suffix, run_period, channels, 923, num_jobs)
    Make_CondorScr("Data_JetMET0_Run2024H_trigsf", "Data_JetMET0_Run2024H_trigsf" + output_suffix, run_period, channels, 131, num_jobs)
    Make_CondorScr("Data_JetMET0_Run2024I_v1_trigsf", "Data_JetMET0_Run2024I_v1_trigsf" + output_suffix, run_period, channels, 138, num_jobs)
    Make_CondorScr("Data_JetMET0_Run2024I_v2_trigsf", "Data_JetMET0_Run2024I_v2_trigsf" + output_suffix, run_period, channels, 130, num_jobs)
    Make_CondorScr("Data_JetMET1_Run2024C_trigsf", "Data_JetMET1_Run2024C_trigsf" + output_suffix, run_period, channels, 243, num_jobs)
    Make_CondorScr("Data_JetMET1_Run2024D_trigsf", "Data_JetMET1_Run2024D_trigsf" + output_suffix, run_period, channels, 232, num_jobs)
    Make_CondorScr("Data_JetMET1_Run2024E_trigsf", "Data_JetMET1_Run2024E_trigsf" + output_suffix, run_period, channels, 314, num_jobs)
    Make_CondorScr("Data_JetMET1_Run2024F_trigsf", "Data_JetMET1_Run2024F_trigsf" + output_suffix, run_period, channels, 698, num_jobs)
    Make_CondorScr("Data_JetMET1_Run2024G_trigsf", "Data_JetMET1_Run2024G_trigsf" + output_suffix, run_period, channels, 922, num_jobs)
    Make_CondorScr("Data_JetMET1_Run2024H_trigsf", "Data_JetMET1_Run2024H_trigsf" + output_suffix, run_period, channels, 131, num_jobs)
    Make_CondorScr("Data_JetMET1_Run2024I_v1_trigsf", "Data_JetMET1_Run2024I_v1_trigsf" + output_suffix, run_period, channels, 137, num_jobs)
    Make_CondorScr("Data_JetMET1_Run2024I_v2_trigsf", "Data_JetMET1_Run2024I_v2_trigsf" + output_suffix, run_period, channels, 130, num_jobs)

    #MC
    Make_CondorScr("TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8_2024_trigsf", "TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8_2024_trigsf" + output_suffix, run_period, channels, 8, 8)
