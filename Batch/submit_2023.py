...
def Make_CondorScr(sampleName, outputName, runPeriod, Channels, NumFileList, NumJob):
    ...
    if "Run2017B" in sampleName:
        ...
        config_file = "Run3/2023/dimuon.config"
...
if __name__ == '__main__':
    ...
    # Data samples
    # Muon0
    Make_CondorScr("Data_Muon0_Run2023C_v1", "Data_Muon0_Run2023C_v1" + output_suffix, run_period, channels, 164, num_jobs)
    Make_CondorScr("Data_Muon0_Run2023C_v2", "Data_Muon0_Run2023C_v2" + output_suffix, run_period, channels, 36, 10)
    Make_CondorScr("Data_Muon0_Run2023C_v3", "Data_Muon0_Run2023C_v3" + output_suffix, run_period, channels, 46, 10)
    Make_CondorScr("Data_Muon0_Run2023C_v4", "Data_Muon0_Run2023C_v4" + output_suffix, run_period, channels, 315, num_jobs)
    Make_CondorScr("Data_Muon1_Run2023C_v1", "Data_Muon1_Run2023C_v1" + output_suffix, run_period, channels, 163, num_jobs)
    Make_CondorScr("Data_Muon1_Run2023C_v2", "Data_Muon1_Run2023C_v2" + output_suffix, run_period, channels, 36, 10)
    Make_CondorScr("Data_Muon1_Run2023C_v3", "Data_Muon1_Run2023C_v3" + output_suffix, run_period, channels, 46, 10)
    Make_CondorScr("Data_Muon1_Run2023C_v4", "Data_Muon1_Run2023C_v4" + output_suffix, run_period, channels, 315, num_jobs)
    ...
    # TTbar samples
    Make_CondorScr("TTbar_Signal", "TTbar_Signal" + output_suffix, run_period, channels, 1, 1)
    Make_CondorScr("TTbar_Hadronic", "TTbar_Hadronic" + output_suffix, run_period, channels, 2, 2)
    Make_CondorScr("TTbar_SemiLeptonic", "TTbar_SemiLeptonic" + output_suffix, run_period, channels, 2, 2)
    ...
    Make_CondorScr("DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8", "DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8" + output_suffix, run_period, channels, 2, 2)
