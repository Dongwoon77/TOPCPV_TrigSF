...
SE_OUTPUT_DIR = "/u/user/dwkim/SE_UserHome/TOP_CPV_output/2022PostEE_trigSF"
...
def Make_CondorScr(sampleName, outputName, runPeriod, Channels, NumFileList, NumJob):
    ...
    if "Run2017B" in sampleName:
        ...
        config_file = "Run3/2022PostEE/muelec.config"
...
if __name__ == '__main__':
    ...
    # Data samples
    Make_CondorScr("Data_JetMET_Run2022E_trigsf", "Data_JetMET_Run2022E_trigsf" + output_suffix, run_period, channels, 217, num_jobs)
    Make_CondorScr("Data_JetMET_Run2022F_trigsf", "Data_JetMET_Run2022F_trigsf" + output_suffix, run_period, channels, 515, num_jobs)
    Make_CondorScr("Data_JetMET_Run2022G_trigsf", "Data_JetMET_Run2022G_trigsf" + output_suffix, run_period, channels, 82, num_jobs)
    
    #MC
    Make_CondorScr("TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8_2022PostEE_trigsf", "TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8_2022PostEE_trigsf" + output_suffix, run_period, channels, 2, 2)
