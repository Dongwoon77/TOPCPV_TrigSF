...
def Make_CondorScr(sampleName, outputName, runPeriod, Channels, NumFileList, NumJob):
    ...
    if "Run2017B" in sampleName:
        ...
        config_file = "Run3/2022PostEE/dimuon.config"
...
if __name__ == '__main__':
    ...
    run_period = "2022PostEE"
    channels = "MuMu"
    num_jobs = 50
    
    # Data samples
    # Muon0
    Make_CondorScr("Data_Muon_Run2022E", "Data_Muon_Run2022E" + output_suffix, run_period, channels, 218, num_jobs)
    Make_CondorScr("Data_Muon_Run2022F", "Data_Muon_Run2022F" + output_suffix, run_period, channels, 515, num_jobs)
    Make_CondorScr("Data_Muon_Run2022G", "Data_Muon_Run2022G" + output_suffix, run_period, channels, 83, num_jobs)
    ...
    # TTbar samples
    Make_CondorScr("TTbar_Signal_postEE", "TTbar_Signal_postEE" + output_suffix, run_period, channels, 2, 2)
    Make_CondorScr("TTbar_Hadronic_postEE", "TTbar_Hadronic_postEE" + output_suffix, run_period, channels, 3, 3)
    Make_CondorScr("TTbar_SemiLeptonic_postEE", "TTbar_SemiLeptonic_postEE" + output_suffix, run_period, channels, 4, 4)
    ...
    Make_CondorScr("DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8_postEE", "DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8_postEE" + output_suffix, run_period, channels, 3, 3)
