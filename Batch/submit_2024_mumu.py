...
def Make_CondorScr(sampleName, outputName, runPeriod, Channels, NumFileList, NumJob):
    ...
    if "Run2017B" in sampleName:
        ...
        config_file = "Run3/2024/dimuon.config"
...
if __name__ == '__main__':
    ...
    # Data samples
    # Muon0
    Make_CondorScr("Data_Muon0_Run2024C", "Data_Muon0_Run2024C" + output_suffix, run_period, channels, 243, num_jobs)
    Make_CondorScr("Data_Muon0_Run2024D", "Data_Muon0_Run2024D" + output_suffix, run_period, channels, 233, num_jobs)
    Make_CondorScr("Data_Muon0_Run2024E", "Data_Muon0_Run2024E" + output_suffix, run_period, channels, 311, num_jobs)
    Make_CondorScr("Data_Muon0_Run2024F", "Data_Muon0_Run2024F" + output_suffix, run_period, channels, 699, num_jobs)
    Make_CondorScr("Data_Muon0_Run2024G", "Data_Muon0_Run2024G" + output_suffix, run_period, channels, 923, num_jobs)
    Make_CondorScr("Data_Muon0_Run2024H", "Data_Muon0_Run2024H" + output_suffix, run_period, channels, 131, num_jobs)
    Make_CondorScr("Data_Muon0_Run2024I", "Data_Muon0_Run2024I" + output_suffix, run_period, channels, 138, num_jobs)
    Make_CondorScr("Data_Muon0_Run2024I_v2", "Data_Muon0_Run2024I_v2" + output_suffix, run_period, channels, 130, num_jobs)

    # Muon1
    Make_CondorScr("Data_Muon1_Run2024C", "Data_Muon1_Run2024C" + output_suffix, run_period, channels, 244, num_jobs)
    Make_CondorScr("Data_Muon1_Run2024D", "Data_Muon1_Run2024D" + output_suffix, run_period, channels, 232, num_jobs)
    Make_CondorScr("Data_Muon1_Run2024E", "Data_Muon1_Run2024E" + output_suffix, run_period, channels, 315, num_jobs)
    Make_CondorScr("Data_Muon1_Run2024F", "Data_Muon1_Run2024F" + output_suffix, run_period, channels, 699, num_jobs)
    Make_CondorScr("Data_Muon1_Run2024G", "Data_Muon1_Run2024G" + output_suffix, run_period, channels, 924, num_jobs)
    Make_CondorScr("Data_Muon1_Run2024H", "Data_Muon1_Run2024H" + output_suffix, run_period, channels, 131, num_jobs)
    Make_CondorScr("Data_Muon1_Run2024I", "Data_Muon1_Run2024I" + output_suffix, run_period, channels, 138, num_jobs)
    Make_CondorScr("Data_Muon1_Run2024I_v2", "Data_Muon1_Run2024I_v2" + output_suffix, run_period, channels, 130, num_jobs)
    ...
    #Make_CondorScr("DYto2E-2Jets_Bin-MLL-50", "DYto2E-2Jets_Bin-MLL-50" + output_suffix, run_period, channels, 30, num_jobs)
    Make_CondorScr("DYto2Mu-2Jets_Bin-MLL-10to50", "DYto2Mu-2Jets_Bin-MLL-10to50" + output_suffix, run_period, channels, 11, 11)
    Make_CondorScr("DYto2Mu-2Jets_Bin-MLL-50", "DYto2Mu-2Jets_Bin-MLL-50" + output_suffix, run_period, channels, 30, num_jobs)
    Make_CondorScr("DYto2Mu-4Jets_Bin-MLL-10to50_TuneCP5_13p6TeV_madgraphMLM-pythia8", "DYto2Mu-4Jets_Bin-MLL-10to50" + output_suffix, run_period, channels, 31, num_jobs)
    Make_CondorScr("DYto2Mu-4Jets_Bin-MLL-50_TuneCP5_13p6TeV_madgraphMLM-pythia8", "DYto2Mu-4Jets_Bin-MLL-50" + output_suffix, run_period, channels, 32, num_jobs)
    #Make_CondorScr("DYto2L-2Jets_Bin-1J-MLL-50-PTLL-100to200", "DYto2L-2Jets_Bin-1J-MLL-50-PTLL-100to200" + output_suffix, run_period, channels, 4, 4)
    #Make_CondorScr("DYto2L-2Jets_Bin-1J-MLL-50-PTLL-200to400", "DYto2L-2Jets_Bin-1J-MLL-50-PTLL-200to400" + output_suffix, run_period, channels, 1, 1)
    #Make_CondorScr("DYto2L-2Jets_Bin-1J-MLL-50-PTLL-400to600", "DYto2L-2Jets_Bin-1J-MLL-50-PTLL-400to600" + output_suffix, run_period, channels, 1, 1)
    #Make_CondorScr("DYto2L-2Jets_Bin-1J-MLL-50-PTLL-40to100", "DYto2L-2Jets_Bin-1J-MLL-50-PTLL-40to100" + output_suffix, run_period, channels, 31, num_jobs)
    #Make_CondorScr("DYto2L-2Jets_Bin-1J-MLL-50-PTLL-600", "DYto2L-2Jets_Bin-1J-MLL-50-PTLL-600" + output_suffix, run_period, channels, 1, 1)
    #Make_CondorScr("DYto2L-2Jets_Bin-2J-MLL-50-PTLL-100to200", "DYto2L-2Jets_Bin-2J-MLL-50-PTLL-100to200" + output_suffix, run_period, channels, 4, 4)
    #Make_CondorScr("DYto2L-2Jets_Bin-2J-MLL-50-PTLL-200to400", "DYto2L-2Jets_Bin-2J-MLL-50-PTLL-200to400" + output_suffix, run_period, channels, 2, 2)
    #Make_CondorScr("DYto2L-2Jets_Bin-2J-MLL-50-PTLL-400to600", "DYto2L-2Jets_Bin-2J-MLL-50-PTLL-400to600" + output_suffix, run_period, channels, 1, 1)
    #Make_CondorScr("DYto2L-2Jets_Bin-2J-MLL-50-PTLL-40to100", "DYto2L-2Jets_Bin-2J-MLL-50-PTLL-40to100" + output_suffix, run_period, channels, 18, num_jobs)
    #Make_CondorScr("DYto2L-2Jets_Bin-2J-MLL-50-PTLL-600", "DYto2L-2Jets_Bin-2J-MLL-50-PTLL-600" + output_suffix, run_period, channels, 1, 1)
