...
def Make_CondorScr(sampleName, outputName, runPeriod, Channels, NumFileList, NumJob):
    ...
    if "Run2017B" in sampleName:
        ...
        config_file = "Run3/2022/dimuon.config"
...
if __name__ == '__main__':
    ...
    # Data samples
    # Muon0
    Make_CondorScr("Data_DoubleMuon_Run2022C", "Data_DoubleMuon_Run2022C" + output_suffix, run_period, channels, 67, 10)
    Make_CondorScr("Data_SingleMuon_Run2022C", "Data_SingleMuon_Run2022C" + output_suffix, run_period, channels, 68, 10)
    Make_CondorScr("Data_Muon_Run2022C", "Data_Muon_Run2022C" + output_suffix, run_period, channels, 191, num_jobs)
    Make_CondorScr("Data_Muon_Run2022D", "Data_Muon_Run2022D" + output_suffix, run_period, channels, 109, num_jobs)
    ...
    Make_CondorScr("TTbar_Hadronic", "TTbar_Hadronic" + output_suffix, run_period, channels, 1, 1)
    Make_CondorScr("TTbar_SemiLeptonic", "TTbar_SemiLeptonic" + output_suffix, run_period, channels, 1, 1)
    ...
    Make_CondorScr("DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8", "DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8" + output_suffix, run_period, channels, 1, 1)
