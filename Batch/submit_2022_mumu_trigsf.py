...
SE_OUTPUT_DIR = "/u/user/dwkim/SE_UserHome/TOP_CPV_output/2022_trigSF"
...
if __name__ == '__main__':
    ...
    # Data samples
    Make_CondorScr("Data_JetMET_Run2022C_trigsf", "Data_JetMET_Run2022C_trigsf" + output_suffix, run_period, channels, 192, num_jobs)
    Make_CondorScr("Data_JetMET_Run2022D_trigsf", "Data_JetMET_Run2022D_trigsf" + output_suffix, run_period, channels, 109, num_jobs)
 
    #MC
    Make_CondorScr("TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8_2022_trigsf", "TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8_2022_trigsf" + output_suffix, run_period, channels, 1, 1)
