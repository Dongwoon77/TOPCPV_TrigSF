...
def Make_CondorScr(sampleName, outputName, runPeriod, Channels, NumFileList, NumJob):
    ...
    for i in range(0, numjobs):
        ...
        f.write('   ./ssb_analysis InputLists/%s/%s/${i}.list %s/%s/%s/%s/${i}.root ULSummer20/UL2016PostVFP/dimuon.config None %s -1 %s/branch_list.txt \n' % (runPeriod, sampleName, outputName, runPeriod, Channels, sampleName, runPeriod, runPeriod))
        f.write('done\n')
        f.close()
...
if __name__ == '__main__':
    # Output name suffix
    output_suffix = "_NanoAOD_v6p2_nonL1prefiring"
    run_period = "UL2016PostVFP"
    channels = "MuMu"
    num_jobs = 10
    ...
    # DoubleMuon
    #Make_CondorScr("Data_DoubleMuon_Run2016F", "Data_DoubleMuon_Run2016F" + output_suffix, run_period, channels, 25, num_jobs)
    #Make_CondorScr("Data_DoubleMuon_Run2016G", "Data_DoubleMuon_Run2016G" + output_suffix, run_period, channels, 427, num_jobs)
    #Make_CondorScr("Data_DoubleMuon_Run2016H", "Data_DoubleMuon_Run2016H" + output_suffix, run_period, channels, 475, num_jobs)
    ...
    # SingleMuon
    #Make_CondorScr("Data_SingleMuon_Run2016F", "Data_SingleMuon_Run2016F" + output_suffix, run_period, channels, 25, num_jobs)
    #Make_CondorScr("Data_SingleMuon_Run2016G", "Data_SingleMuon_Run2016G" + output_suffix, run_period, channels, 427, num_jobs)
    #Make_CondorScr("Data_SingleMuon_Run2016H", "Data_SingleMuon_Run2016H" + output_suffix, run_period, channels, 475, num_jobs)
    
    # TTbar samples
    Make_CondorScr("TTbar_Signal", "TTbar_Signal" + output_suffix, run_period, channels, 49, num_jobs)
    Make_CondorScr("TTbar_AllHadronic", "TTbar_AllHadronic" + output_suffix, run_period, channels, 146, num_jobs)
    Make_CondorScr("TTbar_SemiLeptonic", "TTbar_SemiLeptonic" + output_suffix, run_period, channels, 138, num_jobs)
    ...
    # DYJets samples
    Make_CondorScr("DYJetsToLL_M_10To50", "DYJetsToLL_M_10To50" + output_suffix, run_period, channels, 25, num_jobs)
    ...
    Make_CondorScr("DYJetsToLL_M_50", "DYJetsToLL_M_50" + output_suffix, run_period, channels, 41, num_jobs)
    #Make_CondorScr("DYJetsToLL_M_50_madgraphMLM", "DYJetsToLL_M_50_madgraphMLM" + output_suffix, run_period, channels, 61, num_jobs)


    Make_CondorScr("WJetsToLNu", "WJetsToLNu" + output_suffix, run_period, channels, 3, 3)
    #Make_CondorScr("WJetsToLNu_madgraphMLM", "WJetsToLNu_madgraphMLM" + output_suffix, run_period, channels, 80, num_jobs)
    
    # TTW, TTZ samples
    Make_CondorScr("TTWJetsToLNu", "TTWJetsToLNu" + output_suffix, run_period, channels, 12, num_jobs)
    Make_CondorScr("TTWJetsToQQ", "TTWJetsToQQ" + output_suffix, run_period, channels, 8, num_jobs)
    Make_CondorScr("TTZToLLNuNu", "TTZToLLNuNu" + output_suffix, run_period, channels, 42, num_jobs)
    Make_CondorScr("TTZToQQ", "TTZToQQ" + output_suffix, run_period, channels, 224, num_jobs)
    
    # ST samples
    Make_CondorScr("ST_s-channel_4f_leptonDecays", "ST_s-channel_4f_leptonDecays" + output_suffix, run_period, channels, 19, num_jobs)
    Make_CondorScr("ST_t-channel_antitop_4f_InclusiveDecays", "ST_t-channel_antitop_4f_InclusiveDecays" + output_suffix, run_period, channels, 35, num_jobs)
    Make_CondorScr("ST_t-channel_top_4f_InclusiveDecays", "ST_t-channel_top_4f_InclusiveDecays" + output_suffix, run_period, channels, 86, num_jobs)
    Make_CondorScr("ST_tW_antitop_5f_NoFullyHadronicDecays", "ST_tW_antitop_5f_NoFullyHadronicDecays" + output_suffix, run_period, channels, 16, num_jobs)
    Make_CondorScr("ST_tW_top_5f_NoFullyHadronicDecays", "ST_tW_top_5f_NoFullyHadronicDecays" + output_suffix, run_period, channels, 11, num_jobs)
    ...
    # Diboson samples
    Make_CondorScr("WW", "WW" + output_suffix, run_period, channels, 41,  num_jobs)
    Make_CondorScr("WZ", "WZ" + output_suffix, run_period, channels, 16,  num_jobs)
    Make_CondorScr("ZZ", "ZZ" + output_suffix, run_period, channels, 17,  num_jobs)
