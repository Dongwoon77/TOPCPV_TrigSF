...
def Make_CondorScr(sampleName, outputName, runPeriod, Channels, NumFileList, NumJob):
    ...
    if "Run2017B" in sampleName:
        ...
        config_file = "Run3/2023BPix/dimuon.config"
...
if __name__ == '__main__':
    ...
    # Data samples
    # Muon0
    Make_CondorScr("Data_Muon0_Run2023D_v1", "Data_Muon0_Run2023D_v1" + output_suffix, run_period, channels, 237, num_jobs)
    Make_CondorScr("Data_Muon0_Run2023D_v2", "Data_Muon0_Run2023D_v2" + output_suffix, run_period, channels, 43, 10)
    Make_CondorScr("Data_Muon1_Run2023D_v1", "Data_Muon1_Run2023D_v1" + output_suffix, run_period, channels, 237, num_jobs)
    Make_CondorScr("Data_Muon1_Run2023D_v2", "Data_Muon1_Run2023D_v2" + output_suffix, run_period, channels, 43, 10)
    ...
    # TTbar samples
    Make_CondorScr("TTbar_Signal_postBPix", "TTbar_Signal_postBPix" + output_suffix, run_period, channels, 1, 1)
    Make_CondorScr("TTbar_Hadronic_postBPix", "TTbar_Hadronic_postBPix" + output_suffix, run_period, channels, 1, 1)
    Make_CondorScr("TTbar_SemiLeptonic_postBPix", "TTbar_SemiLeptonic_postBPix" + output_suffix, run_period, channels, 1, 1)
    ...
    Make_CondorScr("DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8_postBPix", "DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8_postBPix" + output_suffix, run_period, channels, 1, 1)
