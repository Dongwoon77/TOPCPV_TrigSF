...
mkdir -p ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TTbar_SemiLeptonic/
cd bTaggingEffi 
./makeBtagEff_All ./input/2024/TTbar_SemiLeptonic/TTbar_SemiLeptonic_${fileListNum}.list ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TTbar_SemiLeptonic/TTbar_SemiLeptonic_${fileListNum} -1
