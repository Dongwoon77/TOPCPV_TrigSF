...
mkdir -p ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/ZZ/
cd bTaggingEffi 
./makeBtagEff_All ./input/2024/ZZ/ZZ_${fileListNum}.list ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/ZZ/ZZ_${fileListNum} -1
