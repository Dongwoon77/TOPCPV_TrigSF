...
mkdir -p ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TWminusto2L2Nu/
cd bTaggingEffi 
./makeBtagEff_All ./input/2024/TWminusto2L2Nu/TWminusto2L2Nu_${fileListNum}.list ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TWminusto2L2Nu/TWminusto2L2Nu_${fileListNum} -1
