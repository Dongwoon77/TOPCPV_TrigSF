...
mkdir -p ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TbarWplustoLNu2Q/
cd bTaggingEffi 
./makeBtagEff_All ./input/2024/TbarWplustoLNu2Q/TbarWplustoLNu2Q_${fileListNum}.list ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TbarWplustoLNu2Q/TbarWplustoLNu2Q_${fileListNum} -1
