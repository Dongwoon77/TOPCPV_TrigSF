...
mkdir -p ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/WZ/
cd bTaggingEffi 
./makeBtagEff_All ./input/2024/WZ/WZ_${fileListNum}.list ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/WZ/WZ_${fileListNum} -1
