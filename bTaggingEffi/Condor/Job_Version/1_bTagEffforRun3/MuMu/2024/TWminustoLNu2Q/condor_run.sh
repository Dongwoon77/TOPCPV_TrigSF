...
mkdir -p ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TWminustoLNu2Q/
cd bTaggingEffi 
./makeBtagEff_All ./input/2024/TWminustoLNu2Q/TWminustoLNu2Q_${fileListNum}.list ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TWminustoLNu2Q/TWminustoLNu2Q_${fileListNum} -1
