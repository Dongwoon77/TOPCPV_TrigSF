...
mkdir -p ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TbarWplusto4Q/
cd bTaggingEffi 
./makeBtagEff_All ./input/2024/TbarWplusto4Q/TbarWplusto4Q_${fileListNum}.list ./output/Job_Version/1_bTagEffforRun3/MuMu/2024/TbarWplusto4Q/TbarWplusto4Q_${fileListNum} -1
