...
mkdir -p ./output/Job_Version/1_bTagEffforRun3/MuMu/2022/TTbar_Hadronic/
cd bTaggingEffi 
./makeBtagEff_All ./input/2022/TTbar_Hadronic/TTbar_Hadronic_${fileListNum}.list ./output/Job_Version/1_bTagEffforRun3/MuMu/2022/TTbar_Hadronic/TTbar_Hadronic_${fileListNum} -1
