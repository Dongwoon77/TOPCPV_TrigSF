...
mkdir -p ./output/Job_Version/1_bTagEffforRun3/MuMu/2022/TTbar_Signal/
cd bTaggingEffi 
./makeBtagEff_All ./input/2022/TTbar_Signal/TTbar_Signal_${fileListNum}.list ./output/Job_Version/1_bTagEffforRun3/MuMu/2022/TTbar_Signal/TTbar_Signal_${fileListNum} -1
